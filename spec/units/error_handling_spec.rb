...
RSpec.describe Low::ErrorHandling do
  ...
  describe '#backtrace' do
    let(:hidden_paths) do
      [
        '/Users/name/dev/app/vendor/bundle/ruby/3.4.0/gems/lowtype/lib/redefiner.rb',
        '/Users/name/dev/app/vendor/bundle/ruby/3.4.0/gems/lowtype/lib/type_expression.rb'
      ]
    end
    let(:backtrace) do
      [
        "    from /Users/name/dev/app/vendor/bundle/ruby/3.4.0/gems/lowtype/lib/redefiner.rb:29:in 'block (4 levels) in redefine'",
        "    from /Users/name/dev/app/vendor/bundle/ruby/3.4.0/gems/lowtype/lib/redefiner.rb:24:in 'Array#each'",
        "    from /Users/name/dev/app/vendor/bundle/ruby/3.4.0/gems/lowtype/lib/redefiner.rb:24:in 'block (3 levels) in redefine'",
        "    from /Users/name/dev/app/lib/models/time_tree/trunk_cone.rb:45:in 'TrunkCone#grow'",
        "    from /Users/name/dev/app/vendor/bundle/ruby/3.4.0/gems/lowtype/lib/redefiner.rb:42:in 'block (3 levels) in redefine'",
